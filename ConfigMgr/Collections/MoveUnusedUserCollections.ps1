...
$moveCollections = @()
$CollectionList = Get-CmCollection | Where-Object {$_.CollectionID -notlike 'SMS*' -and $_.CollectionType -eq '1'} | Select-Object -Property Name,MemberCount,CollectionID,IsReferenceCollection

$destCollFolder = "$($SiteCode):\UserCollection\Archive"
